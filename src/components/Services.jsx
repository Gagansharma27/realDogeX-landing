    ...
    <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
      ...
      <div className="flex-1 flex flex-col justify-start items-center">
        ...
        <ServiceCard
          ...
          subtitle="We use US dollars for all of our real-money transactions. No more weird, hidden conversions"
          delay="500"
        />
        <ServiceCard
          color="bg-[#F84550]"
          ...
          subtitle="Make your crypto work for you! Our wallet will show you how to earn crypto securely - easily"
          delay="600"
        />
      </div>
    </div>
